...
const i18n = {
  en: {
    ...
    bulut_role:    'Game Designer',
    bulut_bio:     'Crafting the worlds players explore. Bulut shapes the gameplay experience through thoughtful design, creative mechanics, and advertising & community strategy.',
    kubra_role:    'UI & Concept Artist',
    kubra_bio:     'Shaping the visual identity of our games. Kübra crafts intuitive UI and stunning concept art that bring our worlds to life.',
    nadir_role:    'Level Designer',
    nadir_bio:     'Designing the stages that define the player journey. Nadir Kaan Sezi builds immersive, handcrafted levels that challenge and captivate.',
  ...
  tr: {
    ...
    bulut_role:    'Oyun Tasarımcısı',
    bulut_bio:     'Oyuncuların keşfettiği dünyaları yaratıyor. Bulut, düşünceli tasarım, yaratıcı mekanikler ve reklam & topluluk stratejisiyle oyun deneyimini şekillendiriyor.',
    kubra_role:    'UI & Konsept Sanatçısı',
    kubra_bio:     'Oyunlarımızın görsel kimliğini şekillendiriyor. Kübra, sezgisel arayüzler ve büyüleyici konsept sanatlarıyla dünyalarımızı hayata geçiriyor.',
    nadir_role:    'Level Tasarımcısı',
    nadir_bio:     'Oyuncu yolculuğunu tanımlayan bölümleri tasarlıyor. Nadir Kaan Sezi, zorlayıcı ve büyüleyici el yapımı level\'lar inşa ediyor.',
  ...
  de: {
    ...
    bulut_role:    'Spiel-Designer',
    bulut_bio:     'Erschafft die Welten, die Spieler erkunden. Bulut gestaltet das Spielerlebnis durch durchdachtes Design, Werbung & Community-Strategie.',
    kubra_role:    'UI- & Konzeptkünstlerin',
    kubra_bio:     'Gestaltet die visuelle Identität unserer Spiele. Kübra erschafft intuitive UI und beeindruckende Konzeptkunst.',
    nadir_role:    'Level-Designer',
    nadir_bio:     'Entwirft die Levels, die die Spielerreise definieren. Nadir Kaan Sezi baut immersive, handgefertigte Levels.',
  ...
  fr: {
    ...
    bulut_role:    'Designer de Jeu',
    bulut_bio:     'Crée les mondes que les joueurs explorent. Bulut façonne l\'expérience de jeu par un design réfléchi, publicité & stratégie communautaire.',
    kubra_role:    'Artiste UI & Concept',
    kubra_bio:     'Forge l\'identité visuelle de nos jeux. Kübra crée des interfaces intuitives et un concept art saisissant.',
    nadir_role:    'Designer de Niveaux',
    nadir_bio:     'Conçoit les niveaux qui définissent le parcours du joueur. Nadir Kaan Sezi bâtit des niveaux immersifs et artisanaux.',
  ...
  es: {
    ...
    bulut_role:    'Diseñador de Juego',
    bulut_bio:     'Crea los mundos que los jugadores exploran. Bulut da forma a la experiencia de juego con diseño reflexivo, publicidad & estrategia comunitaria.',
    kubra_role:    'Artista UI & Concepto',
    kubra_bio:     'Forja la identidad visual de nuestros juegos. Kübra crea interfaces intuitivas y arte conceptual impresionante.',
    nadir_role:    'Diseñador de Niveles',
    nadir_bio:     'Diseña los niveles que definen el viaje del jugador. Nadir Kaan Sezi construye niveles inmersivos y artesanales.',
  ...
  ja: {
    ...
    team_title:    '<span>チーム</span>メンバー',
    team_desc:     '大きな野望を持つ小さなチーム — 各メンバーはそれぞれの専門家であり、一緒になれば無敵です。',
    bilal_role:    'ファウンダー & デベロッパー',
    bilal_bio:     'Deep Interactive のビジョナリー。ビラルはイスタンブールからスタジオの開発とクリエイティブ方向性を牽引しています。',
    bulut_role:    'ゲームデザイナー',
    bulut_bio:     'プレイヤーが探索する世界を創り上げる。ブルットは丁寧なデザインと広告・コミュニティ戦略でゲーム体験を形作ります。',
    kubra_role:    'UI & コンセプトアーティスト',
    kubra_bio:     'ゲームのビジュアルアイデンティティを構築する。キュブラは直感的な UI と迫力あるコンセプトアートで世界観を彩ります。',
    nadir_role:    'レベルデザイナー',
    nadir_bio:     'プレイヤーの旅を定義するステージを設計する。ナディル・カーン・セジは没入感あふれる手作りのレベルを丁寧に構築します。',
    isaac_role:    '3D アーティスト',
    isaac_bio:     'ビジュアルな世界を生き生きと表現する。アイザック・ロハスはゲームの美学を定義する 3D 環境を作り上げます。',
  ...
  zh: {
    ...
    team_title:    '我们的<span>团队</span>',
    team_desc:     '一个怀揣大梦想的精小团队 — 每位成员都是专家，携手无往不胜。',
    bilal_role:    '创始人 & 开发者',
    bilal_bio:     'Deep Interactive 的远见者。Bilal 从伊斯坦布尔主导开发工作，引领工作室的创意方向。',
    bulut_role:    '游戏设计师',
    bulut_bio:     '构建玩家探索的世界。Bulut 通过深思熟虑的设计、广告推广与社区运营策略，塑造完整的游戏体验。',
    kubra_role:    'UI & 概念艺术师',
    kubra_bio:     '打造游戏的视觉形象。Kübra 设计直观的界面和震撼的概念艺术，让世界观跃然纸上。',
    nadir_role:    '关卡设计师',
    nadir_bio:     '设计定义玩家旅程的关卡。Nadir Kaan Sezi 精心打造沉浸式的手工关卡，挑战与魅力并存。',
    isaac_role:    '3D 美术师',
    isaac_bio:     '将视觉世界赋予生命。Isaac Rojas Sepulveda 雕刻出定义游戏美学的精美 3D 场景。',
